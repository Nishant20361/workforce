  ...
  const startRecording = async () => {
    try {
      if (!navigator.mediaDevices?.getUserMedia || typeof MediaRecorder === "undefined") {
        toast.error("Voice recording is unavailable in this browser / आवाज़ रिकॉर्डिंग उपलब्ध नहीं है");
        return;
      }
      ...
      toast.error("Microphone permission नहीं मिला या microphone उपलब्ध नहीं है।");
      ...
      {!recording && !audioBlob && (
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <Mic className="h-4 w-4" /> शुरू करें / Start
            </button>
            <button
              type="button"
      ...
      {recording && (
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-slate-500 hidden sm:inline">रिकॉर्डिंग जारी है...</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <Square className="h-3.5 w-3.5 fill-current" /> रोकें / Stop
            </button>
            <button
              type="button"
              onClick={cancelRecording}
      ...
      {!recording && audioBlob && (
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-500">तैयार है / Ready to send</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {uploading ? (
                ...
                <>
                  <Send className="h-3.5 w-3.5" /> भेजें / Send
                </>
              )}
            </button>
          </div>
