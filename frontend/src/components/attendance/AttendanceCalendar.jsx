...
const WEEKDAYS = [
  { hi: "सोम", en: "Mon", full: "Monday" },
  { hi: "मंगल", en: "Tue", full: "Tuesday" },
  { hi: "बुध", en: "Wed", full: "Wednesday" },
  { hi: "गुरु", en: "Thu", full: "Thursday" },
  { hi: "शुक्र", en: "Fri", full: "Friday" },
  { hi: "शनि", en: "Sat", full: "Saturday" },
  { hi: "रवि", en: "Sun", full: "Sunday" },
];
    ...
    >
      ...
      {workerInfo && (
        <div className="flex flex-wrap items-center justify-between gap-4 pb-4 mb-4 border-b border-stone-100">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                ...
                {workerInfo.joining_date && (
                  <span className="ml-2 text-slate-400">· शामिल: {workerInfo.joining_date}</span>
                )}
              </p>
            </div>
          </div>
          ...
          <Badge className="bg-teal-50 text-teal-900 border-teal-200 text-xs font-bold px-3 py-1.5 rounded-xl">
            ...
            हाज़िरी दर: {summary.attendance_rate}%
          </Badge>
        </div>
      )}
      ...
      {loading && (
        <div className="py-16 flex flex-col items-center justify-center text-slate-400 gap-2">
          ...
          <p className="text-xs font-medium">कैलेंडर लोड हो रहा है... / Loading attendance...</p>
        </div>
      )}
      ...
      {!loading && error && (
        <div className="bg-rose-50 border border-rose-200 rounded-2xl p-6 text-center text-rose-800 my-4 space-y-3">
          ...
          <p className="text-xs text-rose-600">हाज़िरी लोड नहीं हो पाई। कृपया दोबारा प्रयास करें।</p>
          <Button
            type="button"
          ...
          >
            <RotateCcw className="h-3.5 w-3.5 mr-1" /> Retry / पुनः प्रयास करें
          </Button>
        </div>
      )}
        ...
        <>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 sm:gap-3 mb-5" data-testid="attendance-summary-cards">
            <div className="bg-emerald-50/70 border border-emerald-200/80 rounded-2xl p-3 text-center sm:text-left">
              ...
              <span className="text-[10px] text-emerald-600/90 font-medium">दिन (1.0x)</span>
            </div>
            ...
            <div className="bg-amber-50/70 border border-amber-200/80 rounded-2xl p-3 text-center sm:text-left">
              ...
              <span className="text-[10px] text-amber-600/90 font-medium">दिन (0.5x)</span>
            </div>
            ...
            <div className="bg-rose-50/70 border border-rose-200/80 rounded-2xl p-3 text-center sm:text-left">
              ...
              <span className="text-[10px] text-rose-600/90 font-medium">दिन (0.0x)</span>
            </div>
            ...
            <div className="bg-stone-50 border border-stone-200 rounded-2xl p-3 text-center sm:text-left">
              ...
              <span className="text-[10px] text-slate-400 font-medium">आज तक छूटे दिन</span>
            </div>
                      ...
                      {!is_future && !is_pre_joining && status ? (
                        ...
                        >
                          <span className="hidden sm:inline">
                            {status === "Present" ? "हाज़िर" : status === "Half Day" ? "आधा" : "गैरहाज़िर"}
                          </span>
            ...
            >
                ...
                <p className="text-xs text-teal-200 mt-1">
                  ...
                  <strong className="text-white font-bold">
                    {selectedDay.status
                      ...
                      ? "Pre-Employment / काम शुरू करने से पहले की तारीख"
                      : selectedDay.is_future
                      ? "Future Date / आगामी तारीख"
                      : "Not Marked / हाज़िरी दर्ज नहीं है"}
                  </strong>
                </p>
              </div>
              ...
              {isAdmin && !selectedDay.is_future && (
                <div className="flex flex-wrap items-center gap-1.5">
                  ...
                  >
                    <CheckCircle2 className="h-3.5 w-3.5 mr-1" /> हाज़िर (P)
                  </Button>
                  <Button
                    type="button"
                    size="sm"
                  ...
                  >
                    <Clock className="h-3.5 w-3.5 mr-1" /> आधा (HD)
                  </Button>
                  <Button
                    type="button"
                    size="sm"
                  ...
                  >
                    <XCircle className="h-3.5 w-3.5 mr-1" /> गैरहाज़िर (A)
                  </Button>
                </div>
              )}
            </div>
